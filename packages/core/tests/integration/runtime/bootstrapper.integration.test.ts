...
/**
 * Integration Tests: HeadlessRuntimeBootstrapper
 *
 * Testa o processo completo de bootstrap do runtime headless,
 * incluindo carregamento da database.
 *
...
describe('HeadlessRuntimeBootstrapper Integration', () => {
