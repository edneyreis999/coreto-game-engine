...
import type { RmmzDatabase, SystemData } from '@coreto/core';
import { RmmzDatabaseFakeBuilder } from '../../../../fakes/RmmzDatabaseFakeBuilder.js';
...
describe('IntegrityValidator', () => {
  ...
  describe('validate', () => {
    it('should return empty array for valid database with no cross-reference issues', () => {
      ...
      const database: RmmzDatabase = new RmmzDatabaseFakeBuilder()
        .withClass({
          id: 1,
          name: 'Warrior',
