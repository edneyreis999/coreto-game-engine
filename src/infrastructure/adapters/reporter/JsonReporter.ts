...
import { ReportSchema } from '@/infrastructure/schemas/report.schema.js';
...
export class JsonReporter implements IReporter {
  ...
  generateReport(metadata: ReportMetadata): Report {
    const trechoSummaries: import('@/core/domain/Report.js').TrechoSummary[] = [];
  ...
  private convertReportToSchema(
    report: Report
  ): import('@/infrastructure/schemas/report.schema.js').Report {
    return {
