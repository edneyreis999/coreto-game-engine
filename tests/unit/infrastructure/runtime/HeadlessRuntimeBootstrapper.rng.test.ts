/**
 * HeadlessRuntimeBootstrapper - RNG Unit Tests
 *
 * Valida integração do DeterministicRNG com HeadlessRuntimeBootstrapper:
 * - RNG é inicializado quando seed é fornecido
 * - RNG não é inicializado quando seed é undefined
